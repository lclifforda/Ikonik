...
export function RealEstateForm({ onSubmit, isLoading }: RealEstateFormProps) {
  ...
  const validateCurrentStep = async () => {
    ...
    switch (currentStep) {
      case 1:
        fieldsToValidate = ["userProfile", "investmentType", "budget", "experience", "timeline"];
        break;
      case 2:
        fieldsToValidate = ["locations"];
        break;
      case 3:
        // Living preferences are optional, but if family is selected, we might want to validate education preferences
        break;
      case 4:
        // Property appreciation preferences are optional
        break;
      case 5:
        // Final step - all remaining fields
        break;
    }
  ...
  const StepIndicator = () => (
    <div className="mb-8">
      ...
      <div className="flex justify-between mt-3 text-sm font-medium">
        <span className={currentStep === 1 ? 'text-blue-600' : currentStep > 1 ? 'text-green-600' : 'text-gray-400'}>
          Profile & Basics
        </span>
        <span className={currentStep === 2 ? 'text-blue-600' : currentStep > 2 ? 'text-green-600' : 'text-gray-400'}>
          Locations
        </span>
        <span className={currentStep === 3 ? 'text-blue-600' : currentStep > 3 ? 'text-green-600' : 'text-gray-400'}>
          Preferences
        </span>
        <span className={currentStep === 4 ? 'text-blue-600' : currentStep > 4 ? 'text-green-600' : 'text-gray-400'}>
          Investment
        </span>
        <span className={currentStep === 5 ? 'text-blue-600' : 'text-gray-400'}>
          Amenities & Final
        </span>
      </div>
    </div>
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-6 border border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <label className="group relative flex items-center space-x-3 cursor-pointer bg-white rounded-xl p-4 border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-100 has-[:checked]:ring-2 has-[:checked]:ring-blue-200 has-[:checked]:shadow-sm">
                <input
                  type="radio"
                  value="investor"
                  ...
                  className="sr-only"
                />
                <div className="w-6 h-6 rounded-full border-2 border-gray-300 group-has-[:checked]:border-blue-500 group-has-[:checked]:bg-blue-500 flex items-center justify-center transition-all duration-200">
                  <div className="w-2 h-2 rounded-full bg-white opacity-0 group-has-[:checked]:opacity-100 transition-opacity duration-200"></div>
                </div>
                <span className="font-medium text-gray-900 group-has-[:checked]:text-blue-900">Investor</span>
              </label>
              <label className="group relative flex items-center space-x-3 cursor-pointer bg-white rounded-xl p-4 border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-100 has-[:checked]:ring-2 has-[:checked]:ring-blue-200 has-[:checked]:shadow-sm">
                <input
                  type="radio"
                ...
                <span className="font-medium text-gray-900 group-has-[:checked]:text-blue-900">Expatriate</span>
              </label>
              <label className="group relative flex items-center space-x-3 cursor-pointer bg-white rounded-xl p-4 border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-100 has-[:checked]:ring-2 has-[:checked]:ring-blue-200 has-[:checked]:shadow-sm">
                <input
                  type="radio"
                ...
                <span className="font-medium text-gray-900 group-has-[:checked]:text-blue-900">Digital Nomad</span>
              </label>
              <label className="group relative flex items-center space-x-3 cursor-pointer bg-white rounded-xl p-4 border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-100 has-[:checked]:ring-2 has-[:checked]:ring-blue-200 has-[:checked]:shadow-sm">
                <input
                  type="radio"
                ...
                <span className="font-medium text-gray-900 group-has-[:checked]:text-blue-900">Family with Children</span>
              </label>
            </div>
            {errors.userProfile && (
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              ...
              <label key={location.value} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-green-300 hover:bg-green-50 transition-all duration-200 has-[:checked]:border-green-500 has-[:checked]:bg-green-100 has-[:checked]:ring-2 has-[:checked]:ring-green-200 has-[:checked]:shadow-sm">
                <input
                  type="checkbox"
                  ...
                  className="sr-only"
                />
                <div className="w-5 h-5 rounded border-2 border-gray-300 group-has-[:checked]:border-green-500 group-has-[:checked]:bg-green-500 flex items-center justify-center transition-all duration-200">
                ...
                <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-green-900">{location.label}</span>
              </label>
            ))}
          </div>
          {errors.locations && (
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { key: "proximity_to_schools", label: "Near Schools", profiles: ["family"] },
                { key: "proximity_to_transport", label: "Near Transport", profiles: ["investor", "expatriate", "digital_nomad", "family"] },
                { key: "proximity_to_amenities", label: "Near Amenities", profiles: ["investor", "expatriate", "digital_nomad", "family"] },
                { key: "quiet_neighborhood", label: "Quiet Area", profiles: ["expatriate", "family"] },
                { key: "expat_community", label: "Expat Community", profiles: ["expatriate", "digital_nomad"] },
                { key: "work_from_home_space", label: "Home Office Space", profiles: ["digital_nomad", "expatriate"] },
                { key: "short_term_rental_friendly", label: "Rental Friendly", profiles: ["investor", "digital_nomad"] },
                { key: "investment_potential", label: "High ROI Potential", profiles: ["investor"] }
              ].filter(pref => !selectedProfile || pref.profiles.includes(selectedProfile)).map((pref) => (
                <label key={pref.key} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 has-[:checked]:border-purple-500 has-[:checked]:bg-purple-100 has-[:checked]:ring-2 has-[:checked]:ring-purple-200 has-[:checked]:shadow-sm">
                  <input
                    type="checkbox"
                    {...register(`livingPreferences.${pref.key}` as const)}
                    className="sr-only"
                  />
                  <div className="w-5 h-5 rounded border-2 border-gray-300 group-has-[:checked]:border-purple-500 group-has-[:checked]:bg-purple-500 flex items-center justify-center transition-all duration-200">
                    <svg className="w-3 h-3 text-white opacity-0 group-has-[:checked]:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-purple-900">{pref.label}</span>
                </label>
              ))}
            </div>
          </div>

          {/* Education Preferences - Only for families */}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      ...
                      <label key={school.value} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 has-[:checked]:border-yellow-500 has-[:checked]:bg-yellow-100 has-[:checked]:ring-2 has-[:checked]:ring-yellow-200 has-[:checked]:shadow-sm">
                        <input
                          type="checkbox"
                          value={school.value}
                          ...
                          className="sr-only"
                        />
                        <div className="w-5 h-5 rounded border-2 border-gray-300 group-has-[:checked]:border-yellow-500 group-has-[:checked]:bg-yellow-500 flex items-center justify-center transition-all duration-200">
                          <svg className="w-3 h-3 text-white opacity-0 group-has-[:checked]:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-yellow-900">{school.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      ...
                      <label key={lang.value} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 has-[:checked]:border-yellow-500 has-[:checked]:bg-yellow-100 has-[:checked]:ring-2 has-[:checked]:ring-yellow-200 has-[:checked]:shadow-sm">
                        ...
                        <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-yellow-900">{lang.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      ...
                      <label key={level.value} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 has-[:checked]:border-yellow-500 has-[:checked]:bg-yellow-100 has-[:checked]:ring-2 has-[:checked]:ring-yellow-200 has-[:checked]:shadow-sm">
                        ...
                        <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-yellow-900">{level.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  <label key={factor.value} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-red-300 hover:bg-red-50 transition-all duration-200 has-[:checked]:border-red-500 has-[:checked]:bg-red-100 has-[:checked]:ring-2 has-[:checked]:ring-red-200 has-[:checked]:shadow-sm">
                    <input
                      type="checkbox"
                      value={factor.value}
                      ...
                      className="sr-only"
                    />
                    <div className="w-5 h-5 rounded border-2 border-gray-300 group-has-[:checked]:border-red-500 group-has-[:checked]:bg-red-500 flex items-center justify-center transition-all duration-200">
                      <svg className="w-3 h-3 text-white opacity-0 group-has-[:checked]:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-red-900">{factor.label}</span>
                  </label>
                ))}
              </div>
            </div>
      ...
      {/* Step 5: Amenities & Final Details */}
      {currentStep === 5 && (
        <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  {[
                    ...
                    <label key={amenity.value} className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-3 border-2 border-gray-200 hover:border-teal-300 hover:bg-teal-50 transition-all duration-200 has-[:checked]:border-teal-500 has-[:checked]:bg-teal-100 has-[:checked]:ring-2 has-[:checked]:ring-teal-200 has-[:checked]:shadow-sm">
                      <input
                        type="checkbox"
                        value={amenity.value}
                        ...
                        className="sr-only"
                      />
                      <div className="w-5 h-5 rounded border-2 border-gray-300 group-has-[:checked]:border-teal-500 group-has-[:checked]:bg-teal-500 flex items-center justify-center transition-all duration-200">
                        <svg className="w-3 h-3 text-white opacity-0 group-has-[:checked]:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
                      <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-teal-900">{amenity.label}</span>
                    </label>
                  ))}
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div className="space-y-6">
              {/* Area Comparison */}
              <div>
                <label className="group relative flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl p-4 border-2 border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-200 has-[:checked]:border-orange-500 has-[:checked]:bg-orange-100 has-[:checked]:ring-2 has-[:checked]:ring-orange-200 has-[:checked]:shadow-sm">
                  <input
                    type="checkbox"
                    {...register("compareAreas")}
                    className="sr-only"
                  />
                  <div className="w-5 h-5 rounded border-2 border-gray-300 group-has-[:checked]:border-orange-500 group-has-[:checked]:bg-orange-500 flex items-center justify-center transition-all duration-200">
                    <svg className="w-3 h-3 text-white opacity-0 group-has-[:checked]:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-900 group-has-[:checked]:text-orange-900">
      ...
      <div className="flex justify-between items-center pt-6">
        <button
          ...
          className="group relative px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-xl shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:bg-gray-300 disabled:hover:bg-gray-200 flex items-center space-x-2"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {currentStep < totalSteps ? (
          <button
            type="button"
            onClick={nextStep}
            className="group relative px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center space-x-2"
          >
            <span>Next</span>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="group relative px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105 disabled:hover:scale-100 flex items-center space-x-2"
          >
            {isLoading ? (
              <>
